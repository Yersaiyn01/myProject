...
export const RegisterModal = ({ onClose }: { onClose: () => void }) => {
  ...
  const getRegistrationError = (caught: unknown) => {
    if (axios.isAxiosError(caught)) {
      if (!caught.response) return 'Cannot reach backend at http://localhost:8090';
          ...
          <>
            ...
            <div className="divider">
              <button
                ...
                onClick={() => { window.location.href = 'http://localhost:8090/auth/login/apple-id/'; }}
              >
              ...
              <button
                ...
                onClick={() => { window.location.href = 'http://localhost:8090/auth/login/google-oauth2/'; }}
              >
